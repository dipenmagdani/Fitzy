                    ...
                    <div class="col-lg-8 p-0 blog-t">
                        ...
                        if (mysqli_num_rows($query2) > 0) {
                            ...
                            for ($i = 1; $i <= $total_page; $i++) {
                                ...
                                ?><a class="<?php echo $active; ?>" href="<?php echo 'blog.php?page=' . $i; ?>"><?php echo $i; ?></a><?php
                                                                                                                                    }
                                                                                                                                    if ($total_page > $page) {
                        ...
                        <div class="sidebar-option">
                            <div class="so-categories">
                                ...
                                <ul>
                                    ...
                                    ?>
                                    <li>
                                        <a href="blog.php?category=yoga">Yoga <span><?php if (isset($Yoga)) {
                                                                                        echo $Yoga;
                                                                                    } else {
                                                                                        echo 0;
                                                                                    } ?></span></a>
                                    ...
                                    <li>
                                        <a href="blog.php?category=running">Running <span><?php if (isset($Running)) {
                                                                                                echo $Running;
                                                                                            } else {
                                                                                                echo 0;
                                                                                            } ?></span></a>
                                    ...
                                    <li>
                                        <a href="blog.php?category=weightloss">Weightloss <span><?php if (isset($Weightloss)) {
                                                                                                    echo $Weightloss;
                                                                                                } else {
                                                                                                    echo 0;
                                                                                                } ?></span></a>
                                    ...
                                    <li>
                                        <a href="blog.php?category=cardio">Cardio <span><?php if (isset($Cardio)) {
                                                                                            echo $Cardio;
                                                                                        } else {
                                                                                            echo 0;
                                                                                        } ?></span></a>
                                    ...
                                    <li>
                                        <a href="blog.php?category=bodybuilding">Body buiding <span><?php if (isset($Bodybuiding)) {
                                                                                                        echo $Bodybuiding;
                                                                                                    } else {
                                                                                                        echo 0;
                                                                                                    } ?></span></a>
                                    ...
                                    <li>
                                        <a href="blog.php?category=nutrition">Nutrition <span><?php if (isset($Nutrition)) {
                                                                                                    echo $Nutrition;
                                                                                                } else {
                                                                                                    echo 0;
                                                                                                } ?></span></a>
                                    ...
                                    <li>
                                        <a href="blog.php?category=other">Other <span><?php if (isset($Other)) {
                                                                                            echo $Other;
                                                                                        } else {
                                                                                            echo 0;
                                                                                        } ?></span></a>
                                            ...
                                            <div class="latest-item">
                                                <div class="li-pic">
                                                    <img src="<?php if (!empty($Img_Title)) {
                                                                    ...
                                                                    echo "img/letest-blog/latest-2.jpg";
                                                                } ?>" alt="">
                                                </div>
                                                <div class="li-text">
