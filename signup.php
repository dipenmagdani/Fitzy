...
if (isset($_POST['btn_submit'])) {
    ...
    if ($password != $c_password) {
        ...
        $query =  mysqli_query($conn, "SELECT * from `user_master` WHERE Username='$username' || Email_Id='$email'");
        ...
        if ($result > 0) {
            ...
            if (empty($filename)) {
                $photo = '';
                $sql = "INSERT INTO `user_master`(`User_Id`, `Email_Id`, `Username`, `Password`, `Role`, `Approve_Datetime`, `Admin_Remark`, `Date_Joined`, `Time_Joined`) VALUES ('$User_Id','$email','$username','$password','customer','$datetime','','$date','$time');";

                $sql1 = "INSERT INTO `customer`(`Customer_Id`, `User_Id`, `Name`, `Gender`, `Birth_Date`, `Age`, `Contact_No`, `Height`, `Weight`, `Physicaly_Handicap`, `Disease_Check`, `Disease_Id`, `Membership_Id`, `Pincode`, `Local_Place`, `City`, `State`, `Country`, `Photo`) VALUES ('$Customer_Id','$User_Id','$name','$gender','$b_date','$age','$telephone',NULL,NULL,'0','0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,'$photo');";
                ...
                <form class="login100-form validate-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="wrap-input100">
                        ...
                        <label for="file" class="up1">
                            <i class="fa fa-cloud-upload" id="upload" style="font-size: 18px;"></i>&nbsp;&nbsp;&nbsp;
