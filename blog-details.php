    ...
    <body>
        ...
        if (isset($_POST['submit'])) {
            ...
            if (mysqli_num_rows($query) != 1) {
                ...
                $sql1 = "SELECT `Photo` FROM `contributor` WHERE `Contributor_Id` = '1'";
        ...
        <section class="blog-details-hero set-bg" data-setbg="<?php if (!empty($Img_Title)) {
                                                                    echo "data:image/jpg;charset=utf8;base64," . base64_encode($Img_Title);
                                                                } else {
                                                                    echo "img/blog/details/hero.jpg";
                                                                } ?>">
            <div class="container">
                <div class="row">
                        ...
                        <div class="blog-details-text">
                            ...
                            <div class="blog-details-pic">
                                <div class="blog-details-pic-item">
                                    <img src="<?php if (!empty($Img1)) {
                                                    echo "data:image/jpg;charset=utf8;base64," . base64_encode($Img1);
                                                } else {
                                                    echo "img/blog/details/details-1.jpg";
                                                } ?>" alt="">
                                </div>
                                <div class="blog-details-pic-item">
                                    <img src="<?php if (!empty($Img2)) {
                                                    echo "data:image/jpg;charset=utf8;base64," . base64_encode($Img2);
                                                } else {
                                                    echo "img/blog/details/details-2.jpg";
                                                } ?>" alt="">
                                </div>
                            </div>
                            ...
                            <div class="blog-details-tag-share">
                                ...
                                <div class="share">
                                    <span>Share</span>
                                    <a href="facebook.php?url=<?php echo "https://www.facebook.com/sharer/sharer.php?u=" . $url; ?>&article=<?php echo $article_id; ?>" target="_blank"><i class="fa fa-facebook"></i> <?php echo sprintf("%02d", $FaceBook) ?></a>
                                    <a href="twitter.php?url=<?php echo "https://twitter.com/intent/tweet?url=" . $url; ?>&article=<?php echo $article_id; ?>" target="_blank"><i class="fa fa-twitter"></i> <?php echo sprintf("%02d", $Twitter) ?></a>
                                    <a href="mail.php?url=<?php echo $url; ?>&article=<?php echo $article_id; ?>" target="_blank"><i class="fa fa-envelope"></i> <?php echo sprintf("%02d", $Mail) ?></a>
                                </div>
                            </div>
                                        ...
                                        <div class="comment-cont" style="background-color: #141414;">
                                            ...
                                            ?>
                                                    <div class="co-item">
                                                        ...
                                                        <div class="co-pic">
                                                            <img src="<?php if (!empty($row[8])) {
                                                                            echo "data:image/jpg;charset=utf8;base64," . base64_encode($row[8]);
                                                                        } else {
                                                                            echo "img/l_icons/user.jpg";
                                                                        } ?>" alt="<?php echo $row[3] ?>">
