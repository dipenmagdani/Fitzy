    ...
    body {
      ...
      *, *:before, *:after {
      ...
      .about-section {
        padding: 50px;
        text-align: center;
        background: linear-gradient(rgba(0,0,0,0.4),rgba(0,0,0,0.4)), url("./img/images/food3.jpg ") ;
        color: white;
...
<div class="about-section">
  ...
  <input type="text" placeholder="Search..">
    ...
    <div class="column">
      <div class="card">
        <img src="./img/images/boy3.jpg" alt="Jane" style="width:100%">
        <div class="container">
    ...
    <div class="column">
      <div class="card">
        <img src="./img/images/boy2.jpg" alt="Jane" style="width:100%">
        <div class="container">
...
<div class="container">
  <div class="row">
    <div class="column-66">
      ...
      <p  style="font-size:20px"> Regularly consuming high-fat foods can increase your cholesterol and triglyceride levels, which can cause plaque to buildup in your arteries. Over time, this can lead to heart attack, stroke or heart disease. Eating a moderate amount of healthful fats such as those found in olive oil, avocados, fish, nuts and seeds helps protect your heart.</p>
  
    </div>
    <div class="column-33">
        <img src="./img/images/food1.jfif" width="335" height="471" >
    </div>
  </div>
</div>
<div class="container" style="background-color:#f1f1f1">
  <div class="row">
    <div class="column-33">
      <img src="./img/images/food6.jpg" alt="App" width="335" height="471">
    </div>
    <div class="column-66">
      <h1 class="xlarge-font"><b>Support for Brain Health</b></h1>
      <h1 class="large-font" style="color:red;"><b></b></h1>
      <p><span  style="font-size:20px" >A healthful diet is just as good for your brain as the rest of your body. Unhealthy foods are linked to a range of neurological problems. Certain nutrient deficiencies increasing the risk of depression. Other nutrients, like potassium, actually involved in brain cell function. A varied, healthful diet keeps your brain functioning properly, and it can promote good mental health as well.</p>
